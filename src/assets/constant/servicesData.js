...
export const services = [
  ...
  icon: Code,
  description: "Création d'un site web professionnel pour présenter votre entreprise, vos services et attirer de nouveaux clients. Solution idéale pour les PME, artisans et professions libérales souhaitant développer leur présence en ligne.",
  features: [
  ...
  options: [
    { 
      ...
      price: 1500, 
      duration: '2 semaines', 
      desc: 'Site vitrine 3 pages + formulaire contact' 
    },
    { 
      id: 'standard', 
      name: 'Standard', 
      price: 2500, 
      duration: '2-3 semaines', 
      desc: 'Site complet 5-7 pages + blog', 
      popular: true 
    },
    { 
      id: 'premium', 
      ...
      desc: 'Site avancé + e-commerce + référencement' 
    }
  ],
  technologies: ["WordPress", "React", "Tailwind CSS", "PHP", "MySQL"],
  rating: 4.9,
  reviewCount: 342,
